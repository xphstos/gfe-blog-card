...
<template>
  <article
    class="overflow-clip group rounded-lg w-[min(100%,340px)] mx-auto focus-within:outline-indigo-700 focus-within:ring isolate shadow bg-white"
  >
    <img
    ...
    <div class="py-6 px-4">
      ...
      <h3 class="font-bold text-xl mt-2 mb-3 text-balance">
